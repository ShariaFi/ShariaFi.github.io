...
class Quiz {
    ...
    async init() {
        ...
        try {
            const response = await fetch('assets/data/quiz-investasi.json');
            ...
            this.section.innerHTML = `<p class="text-brand-secondary text-center">Gagal memuat kuis.</p>`;
        }
    }
    ...
    renderSkeleton() {
        ...
        this.feedbackEl.addEventListener('click', (e) => {
            ...
            if (learnMoreBtn) {
                ...
                this.eventBus.publish('navigateToTab', targetTab);
            }
        });
    }
